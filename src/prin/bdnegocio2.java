...
public class bdnegocio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnReporte.setBackground(new java.awt.Color(153, 153, 255));
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nombreProducto", "precioUnitario", "cantidadProducto", "fechaVencimiento"
            }
        ));
        ...
        LIBRERIa.setText("Granjas Don Pavon");
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        try{
            InputStream archivo;
            archivo = getClass().getResourceAsStream("/reportes/clientesreport.jrxml");
    ...
    void modificar(){
        ...
        String nombrez = txtNombre.getText();
        String precioz = txtPrecio.getText();
        String cantidadz = txtCantidad.getText();
        String fechaz = txtFecha.getText();
        
        try{
            if ( cod.equals("") ||  nombrez.equals("")|| precioz.equals("") || cantidadz.equals("") || fechaz.equals("")){
                JOptionPane.showMessageDialog(null , "Faltan ingresar datos");
                limpiarTabla();
            } else{
                String sql= "Update clientes set id ='"+cod+"', nombre='"+nombrez+"' , precio ='"+precioz+"', cantidad ='"+cantidadz+"' , fecha='"+fechaz+"' where id=" +cod; 
    ...
    void agregar(){
       ...
       String cod = txtCodigo.getText();
        ...
        try{
            if ( cod.equals("") ||  Nombre.equals("")|| Precio.equals("") || Cantidad.equals("") || Fecha.equals("")){
                ...
                String sql= "insert into clientes (id,nombre,precio,cantidad,fecha) values ('"+cod+"','"+Nombre+"','"+Precio+"','"+Cantidad+"','"+Fecha+"')";
     ...
     void eliminar(){
        ...
        try{
            PreparedStatement elimi= conet.prepareStatement("DELETE FROM  clientes WHERE id ='"+cod+"' ");
        elimi.executeUpdate();
        JOptionPane.showMessageDialog(null, "Producto eliminado");
        }catch(Exception e){
